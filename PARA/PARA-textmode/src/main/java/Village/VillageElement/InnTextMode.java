...
public class InnTextMode {
    ...
    public InnTextMode(Screen screen, TerminalPosition start, TerminalPosition end, Game game) {
        this.screen = screen;
        ...
        while (run) {
            ...
            if (key != null) {
                if (key.getKeyType() == KeyType.ArrowLeft ||
                    ...
                    removeWindow.setInformation("Do you want to add " + elements.get(activation).getLabel() + "?");
                    ...
                    removeWindow.setActionLeftButton(new Action() {
                        @Override
                        public boolean run() throws IOException {
                            game.addCharacterToUser(game.getInn().getCharacters().get(finalActivation));
